#!/bin/bash
# Batch evaluation script for celeba64_uvit_small baseline checkpoints
...
NUM_GPUS=6
CHECKPOINT_DIR="/home/sunj11/Documents/U-ViT-fresh/workdir/celeba64_uvit_small/default_20260101_030900/ckpts"
RESULTS_DIR="eval_results/celeba64_uvit_small/${TIMESTAMP}"
SAMPLES_DIR="eval_samples/celeba64_uvit_small/${TIMESTAMP}"
